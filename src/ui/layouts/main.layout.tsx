		...
		<>
			<div className="min-h-screen min-w-screen flex flex-col  bg-background  p-5  ">
				...
				<div id="navbar" className="text-2xl top-3 left-3 flex gap-x-4 ">
					...
					<a href='https://github.com/joelquispe'  target='_blank' className="text-white cursor-pointer">
						<FaGithub />
					</a>
					<a  href='https://gitlab.com/jquispe' target='_blank' className="text-white cursor-pointer">
						<FaGitlab />
					</a>
				</div>
				<div className={`flex-1 flex   transition-all duration-500 delay-75 ease-in-out ${isDrawer ? 'blur-md' : 'blur-none'}`}>
					<Outlet />
				</div>
			</div>
		</>
